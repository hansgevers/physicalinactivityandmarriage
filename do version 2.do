...
graph bar (count), over(sphus, label(angle(90) labsize(small))) over(Qyear, label(angle(0) labsize(small))) scheme(s2color) ytitle("Number of respondents", margin(small)) ylabel(0(2500)20000,angle(0) labsize(small) grid)
graph export descrip4.png, replace height(2400)
...
xtlogit phinact age yedu i.gender i.thinc i.mst i.gali i.cjs c.bmi ib1.changed##c.eurod i.country, or baselevels vce(robust)
...
xtlogit phinact age yedu i.gender i.thinc i.single i.gali i.cjs c.bmi ib1.schanged##c.eurod i.country, or baselevels vce(robust)
...
xtlogit phinact age yedu i.gender i.thinc i.mst i.sphus i.cjs c.bmi ib1.changed##c.eurod i.country, or baselevels vce(robust)
...
xtlogit phinact age yedu i.gender i.thinc i.single i.sphus i.cjs c.bmi ib1.schanged##c.eurod i.country, or baselevels vce(robust)
